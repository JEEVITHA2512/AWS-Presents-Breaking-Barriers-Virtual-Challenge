...
async def send_to_bedrock(user_message):
...
async def main():
    try:
        ...
        user_message = "Please provide information based on the provided document."
        response_text = await send_to_bedrock(user_message)
...
if __name__ == "__main__":
    try:
        ...
        print(f"An error occurred while running asyncio: {e}")
