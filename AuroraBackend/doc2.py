...
def main():
    ...
    try:
        ...
        if combined_transcription.strip():
            ...
            # No transcription received, play the message using Polly

            print("No transcription received, playing fallback message...")

            synthesize_speech("Hi, I didn't quite catch what you just said. Could you please repeat?")
